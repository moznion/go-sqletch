...
- config: replace `queries`/`output` with multi-target `targets` (doc 19) by @moznion in https://github.com/moznion/go-sqletch/pull/134
- build(deps): bump Songmu/tagpr from 1.20.2 to 1.20.3 by @dependabot[bot] in https://github.com/moznion/go-sqletch/pull/131
- build(deps): bump github.com/go-sql-driver/mysql from 1.10.0 to 1.10.1 by @dependabot[bot] in https://github.com/moznion/go-sqletch/pull/132
- build(deps): bump github.com/ncruces/go-sqlite3 from 0.35.3 to 0.35.4 by @dependabot[bot] in https://github.com/moznion/go-sqletch/pull/133
